...
class Email extends \yii\base\Model
{
    ...
    public function createKeys()
    {
        return Yii::$app->config->add(
            [
                ['key'   => 'admin_email', 'default' => 'admin@nexify.co.ke', 'category' => self::CATEGORY, 'disposition' => 2, 'label' => 'Admin Email'],
                ['key'   => 'sender_email', 'default' => 'info@nexify.co.ke', 'category' => self::CATEGORY, 'disposition' => 3, 'label' => 'Sender Email'],
                ...
                ['key'   => 'smtp_user', 'default' => 'noreply@nexify.co.ke', 'category' => self::CATEGORY, 'disposition' => 6, 'label' => 'SMTP Username'],
